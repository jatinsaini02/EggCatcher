...
c.create_oval(0,0,120,120,fill='orange' , width=0)
c.pack()

color_cycle = cycle(['blue' , 'light pink' , 'light yellow','light green' , 'red', 'blue' , 'light green','black'])
egg_width = 45
egg_height = 55
egg_score = 10
egg_speed = 50
...
def egg_dropped(egg):
    ...
    if lives_remaning == 0:
        ...
        if score>=x:
            ...
            2
            #messagebox.showinfo("Highscore",+" "+str(x))
